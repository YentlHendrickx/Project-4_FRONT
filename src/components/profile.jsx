...
export default function Profile({ handleLogout }) {
          ...
          if (name === "oldPassword") {
            ...
            if (passwordError === "") {
              errors.newPasswordConfirm =
                passwordFormData.newPasswordConfirm !== value
  ...
  async function handleChangeEmail(event) {
    ...
    await axios
      .put(process.env.REACT_APP_API_URL + "User/changeemail/", newEmail)
      .error((err) => {
        console.warn(err);
      });
  ...
  async function handleChangePassword(event) {
    ...
    await axios
      .post(process.env.REACT_APP_API_URL + "User/changepassword/", newPassword)
      .error((err) => {
        console.warn(err);
      });
      ...
      <div className="w-full h-full flex flex-col items-center mt-4">
        ...
        <div className="w-full flex flex-col">
          <div className="mt-6">
            ...
            <form
              className="flex flex-col mx-2 items-center mt-2 gap-4"
            ...
            >
              ...
              />
              <button
                className="bg-save hover:bg-saveHover text-uiLight rounded-md w-[80%] md:w-[20%] "
                type="submit"
              >
                Change email
              </button>
